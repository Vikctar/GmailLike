package com.vikcandroid.gmaillike.activity;
...
import com.vikcandroid.gmaillike.adapter.MessagesAdapter;
import com.vikcandroid.gmaillike.model.Message;
import com.vikcandroid.gmaillike.network.ApiClient;
import com.vikcandroid.gmaillike.network.ApiInterface;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, MessagesAdapter.MessageAdapterListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesAdapter = new MessagesAdapter(this, messages, this);
    ...
    /**
     * Fetches all mail messages making HTTP request
     */
    private void getInbox() {
        ...
        Call<List<Message>> call = apiInterface.getInbox();
    ...
    private void deleteMessages() {
        ...
        List<Integer> selectedItemPositions =
                messagesAdapter.getSelectedItems();
        for (int i = selectedItemPositions.size() - 1; i >= 0; i--) {
            messagesAdapter.removeData(selectedItemPositions.get(i));
        }
        messagesAdapter.notifyDataSetChanged();
    }
}
